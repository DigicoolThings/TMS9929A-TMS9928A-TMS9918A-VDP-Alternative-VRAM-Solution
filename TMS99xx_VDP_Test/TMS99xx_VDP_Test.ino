...
* testVRAM() does a multi-pass test of the VRAM using either a nibble or byte pattern,  
...
*/
  ...
  // Use for loop if you'd like to repeat the pattern
...
//   }
  ...
  // Simple VRAM Test by reading and reporting Pattern 0 just stored in Pattern Table
/*
...
*/
  ...
  writeVramByteVDP(0x01); // Tramsparent (color 0) on bits, Black (color 1) off bits 
/*  
  // Following will instead setup the same Color for all 256 possible Patterns
...
*/
  ...
  // Use the following vram call block if you only want single VRAM test (and setup)
/**/  
...
void loop() {
  // Use the following vram call etc block if you want repeated VRAM tests (and subsequent VRAM setup)
/*
  Serial.println();
